 ...
 */
public class SijiaTextView extends TextView {
    ...
    public SijiaTextView(Context context) {
        super(context);
    }

    public SijiaTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (attrs != null) {
    ...
    public SijiaTextView(Context context, AttributeSet attrs, int defStyleAttr) {
